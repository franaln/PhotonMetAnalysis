...
plots_conf['ph_pt[0]']     = PlotConf('p_{T}^{#gamma} [GeV]', 'Events', 'right')
...
plots_conf['met_et']       = PlotConf('E_{T}^{miss} [GeV]', 'Events', 'right')
...
plots_conf['dphi_jetmet']  = PlotConf('#Delta#phi(jet, E_{T}^{miss})', 'Events / BIN', 'top', logy=True)
plots_conf['dphi_gamjet']  = PlotConf('#Delta#phi(#gamma, jet)', 'Events / BIN', 'top', logy=True)
plots_conf['dphi_gammet']  = PlotConf('#Delta#phi(#gamma, E_{T}^{miss})', 'Events / BIN', 'top', logy=True)
