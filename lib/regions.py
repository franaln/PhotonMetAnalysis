...
# ## Intermediate MET
# VRM1_L = 'ph_n==1 && el_n+mu_n==0 && ph_pt[0]>145 && met_et>75 && met_et<175 && jet_n>4 && dphi_jetmet>0.4 && dphi_gammet>0.4 && meff>1000 && rt4<0.9'
# VRM2_L = 'ph_n==1 && el_n+mu_n==0 && ph_pt[0]>145 && met_et>75 && met_et<175 && jet_n>4 && dphi_jetmet>0.4 && dphi_gammet>0.4 && meff>1500 && rt4<0.9'
# VRM3_L = 'ph_n==1 && el_n+mu_n==0 && ph_pt[0]>145 && met_et>75 && met_et<175 && jet_n>4 && dphi_jetmet>0.4 && dphi_gammet>0.4 && meff>2000 && rt4<0.9'

# VRM1_H = 'ph_n==1 && el_n+mu_n==0 && ph_pt[0]>400 && met_et>125 && met_et<175 && jet_n>2 && dphi_jetmet>0.4 && meff>1000'
# VRM2_H = 'ph_n==1 && el_n+mu_n==0 && ph_pt[0]>400 && met_et>125 && met_et<175 && jet_n>2 && dphi_jetmet>0.4 && meff>1500'
# VRM3_H = 'ph_n==1 && el_n+mu_n==0 && ph_pt[0]>400 && met_et>125 && met_et<175 && jet_n>2 && dphi_jetmet>0.4 && meff>2000'

# ## Reverse dphi cuts
# VRD1_L = 'ph_n==1 && el_n+mu_n==0 && ph_pt[0]>145 && met_et>200 && jet_n>2 && dphi_jetmet<0.4 && dphi_gammet>0.4 && meff>1000'
# VRD2_L = 'ph_n==1 && el_n+mu_n==0 && ph_pt[0]>145 && met_et>200 && jet_n>2 && dphi_jetmet<0.4 && dphi_gammet>0.4 && meff>1500'
# VRD3_L = 'ph_n==1 && el_n+mu_n==0 && ph_pt[0]>145 && met_et>200 && jet_n>2 && dphi_jetmet<0.4 && dphi_gammet>0.4 && meff>2000'

# VRD1_H = 'ph_n==1 && el_n+mu_n==0 && ph_pt[0]>145 && met_et>400 && jet_n>2 && dphi_jetmet<0.4 && dphi_gammet>0.4 && meff>1000'
...
## Plots
SRimetb_L = 'ph_n>0 && el_n+mu_n==0 && ph_pt[0]>145 && met_et<200 && jet_n>4 && dphi_jetmet>0.4 && dphi_gammet>0.4 && meff>2000 && rt4<0.9'
SRimetb_H = 'ph_n>0 && el_n+mu_n==0 && ph_pt[0]>400 && met_et<200 && jet_n>2 && dphi_jetmet>0.4 && dphi_gammet>0.4 && meff>2000' 

SRimetb2_L = 'ph_n>0 && el_n+mu_n==0 && ph_pt[0]>145 && met_et<200 && jet_n>4 && dphi_jetmet>0.4 && dphi_gammet>0.4 && meff>1500 && rt4<0.9'
SRimetb2_H = 'ph_n>0 && el_n+mu_n==0 && ph_pt[0]>400 && met_et<200 && jet_n>2 && dphi_jetmet>0.4 && dphi_gammet>0.4 && meff>1500' 

SRimetb3_L = 'ph_n>0 && el_n+mu_n==0 && ph_pt[0]>145 && met_et<200 && jet_n>4 && dphi_jetmet>0.4 && dphi_gammet>0.4 && meff>1000 && rt4<0.9'
SRimetb3_H = 'ph_n>0 && el_n+mu_n==0 && ph_pt[0]>400 && met_et<200 && jet_n>2 && dphi_jetmet>0.4 && dphi_gammet>0.4 && meff>1000' 
